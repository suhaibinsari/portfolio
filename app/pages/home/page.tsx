				...
				<div className='flex flex-col items-center justify-center w-full'>
					<AnimatePresence>
						<motion.div
							...
							className='flex flex-col md:flex-row gap-5 md:items-center justify-between w-full lg:w-[60rem] md:w-[40rem]'
						>
							<div><h1 className='font-Concert font-bold text-5xl lg:text-7xl'>Hey there <br /> I&apos;m Suhaib</h1></div>
							<div><p className='text-base font-Poppins w-[10rem] '>Frontend/ UI/Ux <br />I love what I do. </p></div>
						</motion.div>
						<motion.div
							initial={{ opacity: 0, x: 50 }}
							animate={{ opacity: 1, x: 0 }}
							transition={{ duration: 0.3 }}
							className='relative lg:-mt-[4rem] flex items-center justify-center w-full'
						>
						...
						<motion.div
							...
							className="absolute flex flex-col md:flex-row gap-5 md:items-center justify-between lg:w-[60rem] md:w-[40rem]"
						>
							<div><Link href=""><p className='font-Poppins lg:block hidden text-[#F3704F] text-base underline'>suhaibinsari@gmail.com </p></Link></div>
							<div className='lg:block hidden '>
								<div className='flex flex-col  items-center justify-center w-[10rem] gap-2'>
									<motion.div
										key="experience"
										initial={{ opacity: 0, y: -50 }}
										animate={{ opacity: 1, y: 0 }}
										...
										className=""
									>
										<Link href="https://drive.google.com/file/d/1BhEtv40cLq2HxY4jrjm_zJc5ZrOdr5Rz/view?usp=sharing" target='_blank'>
											<Image src={cv} alt="no-img" width={35} height={35} />
										</Link>
									</motion.div>
									<motion.div
										key="experience"
										...
										className=""
									>
										<Link href="https://www.linkedin.com/in/suhaibinsari/" target='_blank'>
											<Image src={li} alt="no-img" width={35} height={35} />
										</Link>
									</motion.div>
									<motion.div
										key="experience"
										...
										className=""
									>
										<Link href="https://www.instagram.com/suhaibinsari/" target='_blank'>
											<Image src={In} alt="no-img" width={35} height={35} />
										</Link>
									</motion.div>
								</div>
							</div>
