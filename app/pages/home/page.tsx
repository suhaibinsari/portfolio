				...
				<div className='flex flex-col items-center justify-center w-full'>
					<AnimatePresence>
						...
						>
							...
							<div><p className='text-base font-Poppins w-[10rem] '>Development & Design <br />I love what I do. </p></div>
						</motion.div>
						<motion.div
								...
								<div className='flex flex-col  items-center justify-center w-[10rem] gap-2'>
									...
									>
										<Link href="https://www.linkedin.com/in/suhaibinsari/" target='_blank'>
											<Image src={li} alt="no-img" width={30} height={30} />
										</Link>
									</motion.div>
									<motion.div
										key="experience"
									...
									>
										<Link href="https://www.instagram.com/suhaibinsari/" target='_blank'>
											<Image src={In} alt="no-img" width={30} height={30} />
										</Link>
									</motion.div>
								</div>
							</div>
