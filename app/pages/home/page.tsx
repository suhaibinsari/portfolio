    ...
    <>
      <div className='bg-[#F8F7F1] py-10 px-4 mx-auto' id="section0">
        <div className='flex flex-col items-center justify-center w-full'>
          ...
          <div className='flex flex-col md:flex-row gap-5 md:items-center justify-between w-full lg:w-[60rem] md:w-[40rem]'>
          ...
          <div className='relative lg:-mt-[4rem] flex items-center justify-center w-full'>
            <Image src={black} width={500} height={500} alt="no-img" className='' />
          </div>

          <div className='absolute flex flex-col md:flex-row gap-5 md:items-center justify-between lg:w-[60rem] md:w-[40rem]'>
            ...
            <div className='flex flex-col items-center justify-center w-[10rem] gap-2'>
              <Link href="/app/cv/Suhaib's Resume.pdf">
          ...
          <div className='absolute mt-[20rem] flex flex-col md:flex-row gap-5 md:items-end justify-between lg:w-[60rem] md:w-[40rem]'>
